// findfile.c
//
// Time-stamp: <05/01/01 14:08:47 keuchel@lightning>
...
XCEFindNextFileA(HANDLE hFind, LPWIN32_FIND_DATAA lpfd)
{
  ...
  res = XCEFindNextFileW(hFind, &fdw);
...
BOOL
XCEFindNextFileW(HANDLE hFind, LPWIN32_FIND_DATAW lpfd)
{
  return FindNextFileW(hFind, lpfd);
}
